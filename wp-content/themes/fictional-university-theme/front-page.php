...
<div class="full-width-split group">
    <div class="full-width-split__one">
        <div class="full-width-split__inner">
            ...
            while ($latest2Events->have_posts()) {
                ...
                // get_template_part('template_parts/event', 'something'); // will look for event-something.php
                get_template_part('template_parts/content', 'event'); // will look for event-event.php
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            <?php
            $latest2Posts = new WP_Query(array(
                "posts_per_page" => 2,
            ));
            while ($latest2Posts->have_posts()) {
                $latest2Posts->the_post();
            ?>
