...
<body <?php body_class() ?>>
    <header class="site-header">
        <div class="container">
            ...
            <a href="<?php echo site_url('/') ?>" class="js-search-trigger site-header__search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    ...
                    <!-- <ul>
                        ...
                        <li <?php if (get_post_type() == 'post') echo 'class="current-menu-item"' ?>><a href="#">Campuses</a></li>
                    </ul> -->
